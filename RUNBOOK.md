...
| 015 | Event date text should not wordwrap | 1 file: `EventRow.vue` line 316 — add `whitespace-nowrap` class | Add `whitespace-nowrap` to the event date text `<p>` class in EventRow.vue. Build and verify. | IN PLAN | — | Gate 1 pending. |
