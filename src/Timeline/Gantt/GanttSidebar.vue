    ...
    <div class="flex w-full h-full">
      ...
      >
        <div class="h-full w-full">
          <div
            class="pointer-events-auto sticky hover:w-1 right-0 inline-flex items-center justify-center hover:transition hover:bg-th-accent top-0 bottom-0 z-[5]"
            :class="{
              'bg-th-accent w-1': tempWidth,
              'bg-th-surface-alt w-px': !tempWidth
            }"
